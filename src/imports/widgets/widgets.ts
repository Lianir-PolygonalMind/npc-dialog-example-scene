...
export class WidgetTextBox extends Widget{
  ...
  constructor(parentUI: Widget | UIShape, textData: TextProperties = null){
    ...
    this.textBoxImage = new UIImage(container, new Texture('assets/archive/panel-large.png'))
    ...
    this.faceImage = new UIImage(container, new Texture("assets/archive/Face.png"))
...
export class WidgetComfirm extends Widget{
  ...
  constructor(parentUI: Widget | UIShape){
    ...
    this.buttonComfirmImage = new UIImage(container, new Texture("assets/archive/button-C-blue.png"))
    ...
    this.buttonCancelImage = new UIImage(container, new Texture("assets/archive/button-C-pink.png"))
...
export class WidgetTalk extends WidgetTextBox{
  ...
  private setClickEvent(){
    ...
    if (!self.inputInstance) {
      ...
      const clickImage = new UIImage(container, new Texture("assets/archive/mouse-left-click_black.png"))
