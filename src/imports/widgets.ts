...
export class WidgetTextBox extends Widget{
  ...
  constructor(parentUI: Widget | UIShape, textData: TextProperties = null){
    ...
    this.textBoxImage = new UIImage(container, new Texture('assets/TalkBubble_Sprite.png'))
    this.textBoxImage.name = 'textBoxImage'
    this.textBoxImage.sourceWidth = 588
    this.textBoxImage.sourceHeight = 287
    this.textBoxImage.width = 588*1+'px'
    this.textBoxImage.height = 287*1+'px'
    ...
    this.faceImage.sourceWidth = 193
    this.faceImage.sourceHeight = 183
    this.faceImage.width = 193*1+'px'
    this.faceImage.height = 183*1+'px'
    this.faceImage.vAlign = 'center'
    this.faceImage.hAlign = 'center'
    this.faceImage.positionX = "-9.5%"
    this.faceImage.positionY = "42%"
...
export class WidgetTalk extends WidgetTextBox{
  ...
  private setClickEvent(){
    ...
    if (!self.inputInstance) {
      ...
      const clickImage = new UIImage(container, new Texture("assets/mouse-left-click_next.png"))
      clickImage.name = 'faceImage'
      clickImage.sourceWidth = 212
      clickImage.sourceHeight = 109
      clickImage.width = '75%'
      clickImage.height = '75%'
      clickImage.vAlign = 'center'
      clickImage.hAlign = 'center'
      clickImage.positionX = "-20%"
      clickImage.positionY = "20%"
  ...
  private lastTextMessage(){
    ...
    if (getTextData(this.textData.dialogId, this.textData.textId)
      ...
      (this.wgTextControlls.childrenWidget[0].container as UIText).value = ""
      this.wgTextControlls.show(true)
    }
  }
